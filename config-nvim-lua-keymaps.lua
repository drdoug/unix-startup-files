...
map( 'n', '<F53>',        vim.lsp.buf.references,               { desc = 'Find all references' })
...
map( 'n', 'K',            vim.lsp.buf.hover,                    { desc = 'Show symbol information' })
...
map( 'n', '<leader>gr',   vim.lsp.buf.references,               { desc = 'Find all references' })

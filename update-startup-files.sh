...
declare -a allFiles=( \
        ...
        config-nvim-lua-vim-settings.lua                ~/.config/nvim/lua/vim-settings.lua \
         \
        config-nvim-lua-plugins-ufo.lua                 ~/.config/nvim/lua/plugins/ufo.lua \
        config-nvim-lua-plugins-diags.lua               ~/.config/nvim/lua/plugins/diags.lua \
        config-nvim-lua-plugins-aerial.lua              ~/.config/nvim/lua/plugins/aerial.lua \
        ...
        config-nvim-lua-plugins-indent-blankline.lua    ~/.config/nvim/lua/plugins/indent-blankline.lua \
        )
